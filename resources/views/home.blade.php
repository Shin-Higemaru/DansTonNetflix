...
<head>
    ...
    <link rel="icon" href="{{asset('img/series.png')}}">
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    <a class="navbar-brand mr-auto mr-lg-0" href="#">Dans ton Netflix</a>
...
{{--            </li>--}}
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Reglages</a>
...
<main role="main" class="container">
    ...
    <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="border-bottom border-gray pb-2 mb-0">MAJ récentes</h6>
...
<script src="{{asset('css/offcanvas.css')}}"></script></body>
</html>